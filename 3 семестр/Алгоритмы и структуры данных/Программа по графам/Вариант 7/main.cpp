...
int main() {
    const size_t COUNT_VERTICES_1 = 7;
    const size_t COUNT_EDGES_1 = 9;

    char v1[COUNT_VERTICES_1] = { 'A', 'B', 'C', 'D', 'E', 'F', 'G' };
    E e1[COUNT_EDGES_1] = {
        {'A', 'B', 1.0}, {'B', 'C', 1.0}, {'B', 'D', 3.0}, {'C', 'D', 1.0}, 
        {'D', 'F', 2.0}, {'D', 'E', 3.0}, {'F', 'E', 1.0}, {'E', 'B', 1.0},
        {'E', 'G', 2.0}
    };
